...
import { cancelSubscription } from "../../../helpers/subscriptions";
...
export default function ModalCancel({ subscriptionId, cancelModalOpen, setCancelModalOpen }) {
  ...
  return (
    <Transition.Root show={cancelModalOpen} as={Fragment}>
      <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto" initialFocus={cancelButtonRef} onClose={setCancelModalOpen}>
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500 dark:text-gray-300">
                      Are you sure you want to cancel your subscription? You will lose access to Tattle immediately.
                    </p>
                  </div>
                </div>
              </div>
