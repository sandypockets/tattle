    ...
    <div className="pt-2 px-2 w-full">
      ...
      <div className="mt-1">
        <input
          ...
          autoComplete={type}
          required={required}
          className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-yellow-300 focus:border-yellow-300 sm:text-sm dark:bg-gray-700 dark:text-gray-300"
