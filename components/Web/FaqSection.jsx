  ...
  return (
    <div className="bg-white">
      <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
        ...
        <p className="mt-4 text-base text-gray-500 max-w-3xl mx-auto">Tattle isn't an ordinary service, and we expect that you might have a few questions. Not to worry, we've got answers.</p>
        <div className="mt-12">
