    ...
    <>
      ...
      <Layout>
        <div className="mt-28 mx-auto max-w-prose pb-12">
          <h1 className="font-extrabold text-5xl">Privacy policy</h1>
          <p className="my-4">
            Your privacy is very important to us. This Privacy Policy covers how we collect, use, disclose, transfer, and store your information. Please take a moment to get to know our practices and contact us if you have any questions.
          </p>
          <h2 className="font-extrabold text-3xl mt-12">Collection and Use of Personal Information</h2>
          <p className="my-4">Personal information is data that can be used to uniquely identify or contact a specific individual.</p>
          <p className="my-4">
          ...
          <p className="my-4">Here are examples of the types of personal information that we collect:</p>
          <ul className="list-disc">
            <li className="my-4 ml-6">
              When you visit our website, connect to our services, contact us, use our software, create a Tattle account, or subscribe to your newsletter, we collect a variety of information, including your email address, device information, IP address, and a record of your communication.
            </li>
            <li className="my-4 ml-6">
              When using our software, we collect additional information such as crash reports, information about the operating system, application version, user language, and whether or not you're logged in.
            </li>
            <li className="my-4 ml-6">
              When using Tattle to update your to-dos, we collect the content you provided, as well as additional information such as access logs and device identifiers.
            </li>
          </ul>
          <h2 className="font-extrabold text-3xl mt-12">How we use your personal information</h2>
          <p className="my-4">
            We collect and process all your personal data in accordance with the relevant data protection regulations, in particular the General Data Protection Regulation (GDPR). This means that we may process your personal information for the purposes described in this Privacy Policy with your consent, if it is necessary for the performance of a contract to which you are party or in order to take steps at your request prior to entering into a contract, if it is necessary for compliance with a legal obligation to which Tattle is subject, or when we have assessed it is necessary for the purposes of the legitimate interests pursued by Tattle or by a third party to whom it may be necessary to disclose information.
          </p>
          <ul className="list-disc">
            <li className="my-4 ml-6">
            ...
            <li className="my-4 ml-6">
              We may use your personal information to send important notices, such as communications about changes to our terms, conditions, and policies. As this information is important to your interaction with Tattle, you may not opt out of receiving these communications.
            </li>
            <li className="my-4 ml-6">
          ...
          <h2 className="font-extrabold text-3xl mt-12">Collection and Use of Non-Personal Information</h2>
          <p className="my-4">
          ...
          <h2 className="font-extrabold text-3xl mt-12">Cookies and Other Technologies</h2>
          <p className="my-4">
          ...
          <h2 className="font-extrabold text-3xl mt-12">Disclosure to Third Parties</h2>
          <p className="my-4">
            We don’t share personal information with anyone outside of Tattle, except for the few exceptions below.
          </p>
          <p className="my-4">
            We work together with other companies who provide information processing services. We only share personal information with these companies if you have agreed to the transfer, or if it is permitted by data protection law. The information we share is limited to the data necessary for the third parties to provide their services. We use these companies for the following services: hosting of our website and support portal, database management, providing our help desk software, sending out newsletters, analyzing our website traffic, hosting our cloud services, manage our app beta testing, and processing our app crash reports. These companies are obligated to protect your information in accordance with data protection law and provide the necessary safeguards. The companies are bound by our instructions, and are not allowed to use the shared data for any other purpose.
          </p>
          <p className="my-4">
            We also share personal information if disclosure of such information is reasonably necessary to satisfy any applicable law, regulation, legal process or enforceable governmental request; to enforce applicable Terms of Service, including investigation of potential violations thereof; to detect, prevent, or otherwise address fraud or security issues; and to protect against harm to the rights, property or safety of Tattle, its users or the public as required or permitted by law.
          </p>
          <p className="my-4">
            If Tattle is involved in a reorganization, merger, or sale, the information we collect may be transferred as part of that transaction.
          </p>
          <h2 className="font-extrabold text-3xl mt-12">Protection of Personal Information</h2>
          <p className="my-4">
            We take appropriate security measures to protect against unauthorized access to or unauthorized alteration, disclosure or destruction of data. These include internal reviews of our data collection, storage and processing practices and security measures, including appropriate encryption and physical security measures to guard against unauthorized access to systems where we store personal data.
          </p>
          <h2 className="font-extrabold text-3xl mt-12">Access to Personal Information</h2>
          <p className="my-4">
            You are entitled to request information about the personal data stored by us, to have incorrect data corrected, or to request the freezing or deletion of your data. For example, you can request the deletion of your Tattle account and its associated email address and content by going into the settings in the application. You are also entitled to the portability of your personal data. Further, you may object to the use of your data at any time with effect for the future.
          </p>
          <p className="my-4">
          ...
          <h2 className="font-extrabold text-3xl mt-12">Children</h2>
          <p className="my-4">
            We do not knowingly collect personal information from children under 18, or equivalent minimum age in the relevant jurisdiction, unless their parent provided verifiable consent. If we learn that we have collected personal information from a child under 18, or equivalent minimum age in the relevant jurisdiction, without consent of their parent, we will take steps to delete this information as soon as possible. Parents or guardians can contact us.
          </p>
          <h2 className="font-extrabold text-3xl mt-12">Third-Party Sites and Services</h2>
          <p className="my-4">
            Tattle’s website or any of our services may contain links to third-party websites or services. We are not responsible for the information collected by those third parties and we encourage you to read their privacy policy before submitting any personal information to them.
          </p>
          <h2 className="font-extrabold text-3xl mt-12">Privacy Questions</h2>
          <p className="my-4">
            If you have any questions regarding our Privacy Policy or data processing, or if you would like to make a complaint about a possible breach of local privacy laws, please contact us.
          </p>
          <p className="my-4">
