...
export default function TermsPage() {
  return (
    <Layout>
      <div className="mt-28 mx-auto max-w-prose pb-12">
        <h1 className="font-extrabold text-5xl">Terms of Use</h1>
        <p className="my-6">Your use of Tattle (the "Service") is governed by this agreement.</p>
        <p className="my-4">By using the Service, you are agreeing to these Terms. Please read them carefully.</p>
        <p className="my-4">
          The Service is available to you if you are 18 years of age or older. If you are 18 or older, but under the age of majority in your country of residence, you must review this agreement with your parent or guardian to make sure that you and your parent or guardian understand it. You may use the Service only if you can form a binding contract with Tattle and are not barred under any applicable laws from doing so.
        </p>
        <h2 className="font-extrabold text-3xl mt-12">Using the Service</h2>
        <p className="my-4">
        ...
        <p className="my-4">
          In order to use the Service, you need to establish an Account. You are solely responsible for the security and confidentiality of your password. You are also responsible for all activities or actions exercised by your Account, and you should immediately notify Tattle if you learn of any unauthorized use of your Account. Please note that we may delete accounts (and all associated Content) that haven’t been used for an extended period of time.
        </p>
        <p className="my-4">
        ...
        <h2 className="font-extrabold text-3xl mt-12">Your Content in the Service</h2>
        <p className="my-4">
        ...
        <p className="my-4">
          You retain full ownership for the Content you upload or otherwise submit to the Service. Tattle does not claim ownership or any intellectual property rights to any of it. We do, however, need certain limited rights in order to operate the Service: you grant Tattle (and those we work with) a worldwide, non-exclusive license to use, host, store, reproduce, modify, create derivative works, communicate, and distribute such Content, without any compensation or obligation to you. The rights you grant in this license are for the limited purpose of operating and improving our Service, and to develop new ones. Make sure you have the necessary rights to grant us this license for any Content that you submit to our Service. We may remove any Content from our Service at our discretion.
        </p>
        <p className="my-4">
          In order to provide the Service and make your Content available, Tattle may transmit your Content across various public networks, in various media, and modify or change your Content to comply with technical requirements of connecting networks or devices or computers. You agree that the license herein permits Tattle to take any such actions.
        </p>
        <p className="my-4">
          You are solely responsible for securing and backing up your Content. Tattle shall use reasonable skill and due care in providing the Service, but has no responsibility or liability for the deletion, corruption, or failure to store any Content maintained or transmitted through your use of the Service.
        </p>
        ...
        <p className="my-4">
          The Software which you use may from time to time automatically download and install updates from Tattle. These updates are designed to improve, enhance and further develop the Service and may take the form of bug fixes, enhanced functions, or entirely new versions of the Software. You agree that Tattle may automatically deliver such updates to you as part of your use of the Service and you shall receive and install them as required.
        </p>
        <p className="my-4">
          Tattle gives you a personal, non-assignable, non-exclusive, limited license to use the Software provided to you by Tattle as part of the Service. The license is for the sole purpose of enabling you to use our Service in the manner permitted in these Terms. You may not (or permit anyone else to) copy, modify, rent, loan, distribute, sell, lease, sublicense, assign, grant a security interest in or otherwise transfer any right in any part of the Service or Software, nor may you reverse engineer, decompile, or otherwise attempt to extract the source code of the Software, unless expressly permitted or required by law.
        </p>
        <h2 className="font-extrabold text-3xl mt-12">Modifying and Terminating the Service</h2>
        <p className="my-4">
        ...
        <p className="my-4">
          You can stop using the Service at any time, although we would be sorry to see you go. Tattle may also stop providing the Service to you at any time, with or without cause, and with or without notice. For example, we may immediately suspend or terminate your use if you are not complying with these Terms, or use the Service in any way that would cause us legal liability or disrupt others’ use of the Service.
        </p>
        <p className="my-4">
          If we suspend or terminate the Service or your Account, we will try to give you reasonable advance notice and a chance to get information out of that Service. After a period of time, however, Tattle may permanently delete the Content that is associated with your Account.
        </p>
        <h2 className="font-extrabold text-3xl mt-12">Exclusions of warranties</h2>
        <p className="my-4">
          ...
          TATTLE MAKES NO EXPRESS WARRANTIES AND DISCLAIMS ALL IMPLIED WARRANTIES REGARDING THE SERVICE INCLUDING IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE AND NON-INFRINGEMENT. WITHOUT LIMITING THE GENERALITY OF THE FOREGOING, TATTLE DOES NOT REPRESENT OR WARRANT TO YOU THAT: (A) YOUR USE OF THE SERVICE WILL MEET YOUR REQUIREMENTS, (B) YOUR USE OF THE SERVICE WILL BE UNINTERRUPTED, TIMELY, SECURE OR FREE FROM ERROR.
        </p>
        <h2 className="font-extrabold text-3xl mt-12">Limitation of Liability</h2>
        <p className="my-4">
          NOTHING IN THESE TERMS, INCLUDING THIS SECTION, SHALL LIMIT TATTLE’S LIABILITY FOR LOSSES WHICH MAY NOT BE LAWFULLY LIMITED BY APPLICABLE LAW.

          YOU EXPRESSLY UNDERSTAND AND AGREE THAT TATTLE SHALL NOT BE LIABLE TO YOU FOR ANY DIRECT, INDIRECT, INCIDENTAL, SPECIAL CONSEQUENTIAL OR EXEMPLARY DAMAGES WHICH MAY BE INCURRED BY YOU, HOWEVER CAUSED AND UNDER ANY THEORY OF LIABILITY. THIS SHALL INCLUDE, BUT NOT BE LIMITED TO, ANY LOSS OF PROFIT (WHETHER INCURRED DIRECTLY OR INDIRECTLY), ANY LOSS OF GOODWILL OR BUSINESS REPUTATION, ANY LOSS OF DATA SUFFERED, COST OF PROCUREMENT OF SUBSTITUTE GOODS OR SERVICES, OR OTHER INTANGIBLE LOSS.

          THE LIMITATIONS ON TATTLE’S LIABILITY TO YOU IN THE PARAGRAPH ABOVE SHALL APPLY WHETHER OR NOT TATTLE HAS BEEN ADVISED OF OR SHOULD HAVE BEEN AWARE OF THE POSSIBILITY OF ANY SUCH LOSSES ARISING.
        </p>
        <h2 className="font-extrabold text-3xl mt-12">Indemnity</h2>
        <p className="my-4">
          You agree to hold harmless and indemnify Tattle, and its affiliates, employees or partners from and against any third party claim arising from or in any way related to (a) your breach of the Terms, (b) your use of the Service, (c) your violation of applicable laws, rules or regulations in connection with the Service, including any liability or expense arising from all claims, losses, damages (actual and consequential), suits, judgments, litigation costs and attorneys’ fees, of every kind and nature. In such a case, Tattle will provide you with written notice of such claim, suit or action.
        </p>
        <p className="my-4">
          Certain components of the Service provided by Tattle may require separate Software or other license agreements or Terms of Use. You must read, accept, and agree to be bound by any such separate agreements as a condition of using these particular components or features of the Service.
        </p>
        <p className="my-4">
          If you do not comply with these Terms, and we don’t take action right away, this doesn’t mean that we are giving up any rights that we may have (such as taking action in the future).
        </p>
        <p className="my-4">
          These Terms control the relationship between you and Tattle, they don’t create any third party beneficiary rights.
        </p>
        <p className="my-4">
